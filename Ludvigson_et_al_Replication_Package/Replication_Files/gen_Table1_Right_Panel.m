% -------------------------------------------------------------------------
% Generate the Variance Decomposition for EPU system, Right Panel of Table 1
% -------------------------------------------------------------------------
...
%% Table 1, Right Panel 
disp('======== SVAR (EPU, ip, Uf) =====')
disp('========Fraction variation in EPU=====')
%lower bound first row, upper bound second row
disp('    EPU Shock, ip Shock, UF Shock, s = 1')
disp([VD_out.Var_1_decomp_bt(1:2,1:3)']')
disp('    EPU Shock, ip Shock, UF Shock, s = 12')
disp([VD_out.Var_12_decomp_bt(1:2,1:3)']')
disp('    EPU Shock, ip Shock, UF Shock, s = inf')
disp([VD_out.Var_inf_decomp_bt(1:2,1:3)']')
disp('    EPU Shock, ip Shock, UF Shock, s = max')
